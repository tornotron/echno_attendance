...
///
/// This class represents exceptions that may occur during Firebase operations,
...
class EchnoFirebaseException implements Exception {
  ...
  EchnoFirebaseException(this.code);
